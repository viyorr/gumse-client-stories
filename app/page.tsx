...
const placeCases = [
  ...
  },
  {
    ...
    before: "월 9건",
    after: "월 21건",
    detail: "서비스별 키워드를 분리하고 사진·소개·리뷰 흐름을 보완해 검색 결과에서 비교하기 쉬운 플레이스를 만들었습니다.",
    tags: ["핵심 키워드 86위 → 8위", "상세 탐색 증가", "문의 질 개선"],
    chats: [
      ["client", "요즘 문의 주시는 분들은 플레이스에서 서비스 범위를 다 보고 오셔서 그런지 질문이 구체적이네요.", "오후 1:26"],
      ["gumse", "특수청소와 입주청소 키워드를 나눠 관리한 뒤 필요한 고객이 더 정확하게 들어오고 있습니다.", "오후 1:29"],
      ["client", "맞아요. 처음부터 전부 설명할 필요가 없으니까 상담 시간도 줄고 실제 견적까지 연결이 잘됩니다.", "오후 1:33"],
    ],
  },
];
